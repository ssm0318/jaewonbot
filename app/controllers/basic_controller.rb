        ...
        if @user.name == nil
            ...
            if  @response == "재원봇 안녕!!"
                ...
                responses = ["제 프로필 사진을 누르면 쿠폰을 발급 받으실 수 있어요!", "[김무성]의 최애 꽃은 수국이예요.", "[박근혜] 화보집 양장본은 49,000원이예요.",
                            ...
                            "[이명박]은 겨울쿨톤이예요.", "[김제동]은 혀로 체리꼭지를 묶을 수 있어요.", "[박근혜]는 올레티비를 시청해요.", "[이명박]의 월 이발 횟수는 [2회]예요."]
                my_response = responses.sample
                @response = {
                    message: {
                        text: my_response
                    },
